...
// characteristic and service information
...
// A big buffer and pointer array to hold our payloads
int num_payloads = 0;
...
/* Function to subscribe to nebula sensor characteristic */
